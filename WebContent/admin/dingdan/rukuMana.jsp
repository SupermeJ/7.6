	...
	<head>
        ...
        <script language="javascript">
           function rukuDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/rukuDel1.action?id="+id;
               }
           }
           ...
           {
                var url="<%=path %>/admin/dingdan/rukuMingxiAdd.jsp?ruku_id="+ruku_id;
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#367CB7" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <a style="color: red" href="#" onclick="rukuMingxiMana(${ruku.id})">订单明细</a>
					    &nbsp;&nbsp;&nbsp;      
					    <a style="color: red" href="#" onclick="rukuMingxiAdd(${ruku.id})">添加订单明细</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
