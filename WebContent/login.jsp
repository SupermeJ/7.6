...
<body>
	...
	<br>
	<br>
	<table width="959" height="523" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;"></div></td>
	 </tr>
	 <tr>
		<td width="809"><form name="ThisForm" method="POST" action="">
				<div style="position:absolute;width:500px;height:200px;top:250px;left:800px"><table width="210" height="198"  border="0" align="right" cellpadding="1" cellspacing="1">
					<tr>
						<td height="60" colspan="1"></td>
					</tr> 
			        <tr>
					    <td width="40" height="22" valign="bottom">
						    <span class="STYLE15" >用户名：</span>
						</td>
						<td width="150" valign="bottom">
					        <input name="userName"  type="text" class="input2" style="width: 150px;">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td height="31" colspan="2" valign="top" class="STYLE15">
						     密&nbsp;&nbsp;&nbsp;&nbsp;码：
							<input name="userPw" type="password" size="21" class="input2" align="bottom" style="width: 150px;">
						</td>
					</tr>
